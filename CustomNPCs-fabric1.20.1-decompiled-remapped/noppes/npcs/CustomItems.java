...
public class CustomItems {
    ...
    public static void registerItems() {
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcwand", (Object)wand);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcmobcloner", (Object)cloner);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcscripter", (Object)scripter);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcmovingpath", (Object)moving);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcmounter", (Object)mount);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcteleporter", (Object)teleporter);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcsoulstoneempty", (Object)soulstoneEmpty);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcsoulstonefilled", (Object)soulstoneFull);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:scripted_item", (Object)((Object)scripted_item));
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:nbt_book", (Object)((Object)nbt_book));
    }
