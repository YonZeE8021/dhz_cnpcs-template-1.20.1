...
extends Goal {
    ...
    private EntityNPCInterface getNearbyNPC() {
        List list = this.entity.getWorld().getOtherEntities((Entity)this.entity, this.entity.getBoundingBox().expand((double)this.entity.ais.walkingRange, this.entity.ais.walkingRange > 7 ? 7.0 : (double)this.entity.ais.walkingRange, (double)this.entity.ais.walkingRange), (Predicate)((Object)this.selector));
    ...
    public boolean shouldContinue() {
        if (this.nearbyNPC != null && (!this.selector.apply((Object)this.nearbyNPC) || this.entity.isInRange((Entity)this.nearbyNPC, this.entity.getWidth()))) {
            return false;
        }
