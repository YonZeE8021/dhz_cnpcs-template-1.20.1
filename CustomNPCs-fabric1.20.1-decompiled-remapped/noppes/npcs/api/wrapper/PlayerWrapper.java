...
implements IPlayer {
    ...
    public boolean giveItem(IItemStack item) {
        ...
        if (bo) {
            NoppesUtilServer.playSound((LivingEntity)this.entity, SoundEvents.field_15197, 0.2f, ((((ServerPlayerEntity)this.entity).getRandom().nextFloat() - ((ServerPlayerEntity)this.entity).getRandom().nextFloat()) * 0.7f + 1.0f) * 2.0f);
            this.updatePlayerInventory();
        }
        return bo;
    }
