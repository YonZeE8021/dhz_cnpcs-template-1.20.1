...
implements IButton {
    ...
    public NbtCompound toNBT(NbtCompound nbt) {
        super.toNBT(nbt);
        nbt.put("texture", (NbtElement)this.texture.toNBT(new NbtCompound()));
        nbt.putInt("textureHoverOffset", this.textureHoverOffset);
        nbt.putString("label", this.label);
        nbt.put("item", (NbtElement)this.item.getItemNbt().getMCNBT());
        return nbt;
    }
    ...
    public CustomGuiComponentWrapper fromNBT(NbtCompound nbt) {
        ...
        ItemStack it = ItemStack.fromNbt((NbtCompound)nbt.getCompound("item"));
