...
implements IPos {
    public static final BlockPosWrapper ZERO = new BlockPosWrapper(BlockPos.ORIGIN);
    ...
    public IPos offset(int direction) {
        return new BlockPosWrapper(this.blockPos.offset(Direction.byId((int)direction)));
    }

    @Override
    public IPos offset(int direction, int n) {
        return new BlockPosWrapper(this.blockPos.offset(Direction.byId((int)direction), n));
    }
