...
implements IScoreboardTeam {
    ...
    public String[] getPlayers() {
        ArrayList list = new ArrayList(this.team.getPlayerList());
    ...
    public void setColor(String color) {
        ...
        this.team.setSuffix((Text)Text.literal((String)Formatting.field_1070.toString()));
    }
    ...
    public String getColor() {
        ...
        for (Formatting format : Formatting.values()) {
            if (!prefix.getString().equals(format.toString()) || format == Formatting.field_1070) continue;
