...
public abstract class MainMenuGui {
    ...
    public MainMenuGui(int active, EntityCustomNpc npc, IPlayer player, boolean renderHeader) {
        ...
        if (renderHeader) {
            ...
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8449)));
            ...
            button.setTextureRect(rect);
            button.setTextureHoverOffset(22).setPos(buttonId * 22 + 4, 0).setID(buttonId++);
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8725)));
            ...
            button.setTextureRect(rect);
            button.setTextureHoverOffset(22).setPos(buttonId * 22 + 4, 0).setID(buttonId++);
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8058)));
            ...
            button.setTextureRect(rect);
            button.setTextureHoverOffset(22).setPos(buttonId * 22 + 4, 0).setID(buttonId++);
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8288)));
            ...
            button.setTextureRect(rect);
            button.setTextureHoverOffset(22).setPos(buttonId * 22 + 4, 0).setID(buttonId++);
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8660)));
            ...
            button.setTextureRect(rect);
            button.setTextureHoverOffset(22).setPos(buttonId * 22 + 4, 0).setID(buttonId++);
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8802)));
            ...
            button.setTextureRect(rect);
            button.setTextureHoverOffset(22).setPos(buttonId * 22 + 4, 0).setID(buttonId++);
            button.setDisplayItem(NpcAPI.Instance().getIItemStack(new ItemStack((ItemConvertible)Items.field_8107)));
            button.setOnPress((gui, b) -> player.showCustomGui(new DisplayMenu((EntityCustomNpc)npc, (IPlayer)player).gui));
            this.gui.addComponent(button);
            button = new CustomGuiButtonWrapper().setSize(22, 20);
            button.setTextureRect(rect);
