...
implements ClientModInitializer {
    public void onInitializeClient() {
        ...
        HandledScreens.register(CustomContainer.container_customgui, (container, inv, comp) -> {
        ...
        new MusicController();
        HudRenderCallback.EVENT.register((Object)new OverlayEventHandler());
        ClientTickEvents.START_CLIENT_TICK.register((Object)new ClientTickHandler());
        ScreenEvents.AFTER_INIT.register((Object)new ClientEventHandler());
