...
ServerPlayConnectionEvents.Disconnect {
    ...
    public ActionResult interact(PlayerEntity player, World world, Hand hand, BlockPos pos, Direction direction) {
        if (world.isClient || hand != Hand.field_5808 || !(world instanceof ServerWorld)) {
    ...
    public ActionResult interact(PlayerEntity player, World world, Hand hand, BlockHitResult hitResult) {
        if (player.getWorld().isClient || hand != Hand.field_5808 || !(world instanceof ServerWorld)) {
            return ActionResult.PASS;
        }
    ...
    public TypedActionResult<ItemStack> interact(PlayerEntity player, World world, Hand hand) {
        ...
        return isCancelled ? TypedActionResult.fail((Object)player.getStackInHand(hand)) : TypedActionResult.pass((Object)player.getStackInHand(hand));
    }
