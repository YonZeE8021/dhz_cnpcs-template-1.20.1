...
implements IJobBuilder {
    ...
    public void aiUpdateTask() {
        ...
        if (this.placing == null) {
            ...
            if (this.placing.state.getBlock() == Blocks.field_10369) {
                this.placing = null;
                return;
            }
            this.tryTicks = 0;
    ...
    private String blockToString(BlockData data) {
        if (data.state.getBlock() == Blocks.field_10124) {
            return Registries.ITEM.getId((Object)Items.field_8403).toString();
        }
