...
implements IJobFollower {
    ...
    public boolean aiShouldExecute() {
        ...
        this.ticks = 10;
        this.following = null;
        List list = this.npc.getWorld().getNonSpectatingEntities(EntityNPCInterface.class, this.npc.getBoundingBox().expand((double)this.getRange(), (double)this.getRange(), (double)this.getRange()));
