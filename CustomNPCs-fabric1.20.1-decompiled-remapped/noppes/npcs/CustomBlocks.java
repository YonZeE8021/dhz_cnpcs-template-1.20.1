...
public class CustomBlocks {
    ...
    public static void registerBlocks() {
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcredstoneblock", (Object)redstone);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcmailbox", (Object)mailbox);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcmailbox2", (Object)mailbox2);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcmailbox3", (Object)mailbox3);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcwaypoint", (Object)waypoint);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcborder", (Object)border);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcscripted", (Object)scripted);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcscripteddoor", (Object)scripted_door);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npcbuilderblock", (Object)builder);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npccopyblock", (Object)copy);
        Registry.register((Registry)Registries.BLOCK, (String)"customnpcs:npccarpentybench", (Object)carpenty);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcredstoneblock", (Object)redstone_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcmailbox", (Object)mailbox_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcmailbox2", (Object)mailbox2_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcmailbox3", (Object)mailbox3_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcwaypoint", (Object)waypoint_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcborder", (Object)border_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcscripted", (Object)scripted_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcscripteddoortool", (Object)scripted_door_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npcbuilderblock", (Object)builder_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npccopyblock", (Object)copy_item);
        Registry.register((Registry)Registries.ITEM, (String)"customnpcs:npccarpentybench", (Object)carpentry_item);
