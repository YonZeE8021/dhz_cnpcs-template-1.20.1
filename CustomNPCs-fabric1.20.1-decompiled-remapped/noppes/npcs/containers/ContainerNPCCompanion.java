...
extends ContainerNpcInterface {
    ...
    public ContainerNPCCompanion(int containerId, PlayerInventory playerInventory, int entityId) {
        ...
        if (this.role.getTalentLevel(EnumCompanionTalent.ARMOR) > 0) {
            this.addSlot(new SlotCompanionArmor(this.role, (Inventory)npc.inventory, 0, 6, 8, EquipmentSlot.field_6169));
            this.addSlot(new SlotCompanionArmor(this.role, (Inventory)npc.inventory, 1, 6, 26, EquipmentSlot.field_6174));
            this.addSlot(new SlotCompanionArmor(this.role, (Inventory)npc.inventory, 2, 6, 44, EquipmentSlot.field_6172));
            this.addSlot(new SlotCompanionArmor(this.role, (Inventory)npc.inventory, 3, 6, 62, EquipmentSlot.field_6166));
        }
