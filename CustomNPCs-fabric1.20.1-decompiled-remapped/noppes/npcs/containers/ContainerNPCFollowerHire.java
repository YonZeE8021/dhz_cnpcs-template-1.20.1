...
extends ContainerNpcInterface {
    public SimpleInventory currencyMatrix;
    ...
    public ContainerNPCFollowerHire(int containerId, PlayerInventory playerInventory, int entityId) {
        ...
        this.currencyMatrix = new SimpleInventory(1);
        this.addSlot(new SlotNpcMercenaryCurrency(this.role, (Inventory)this.currencyMatrix, 0, 44, 35));
        for (int i1 = 0; i1 < 3; ++i1) {
            for (int l1 = 0; l1 < 9; ++l1) {
                this.addSlot(new Slot((Inventory)this.player.getInventory(), l1 + i1 * 9 + 9, 8 + l1 * 18, 84 + i1 * 18));
            }
        }
