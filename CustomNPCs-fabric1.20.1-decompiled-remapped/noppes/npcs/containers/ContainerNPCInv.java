...
extends ScreenHandler {
    public ContainerNPCInv(int containerId, PlayerInventory playerInventory, int entityId) {
        ...
        this.addSlot(new SlotNPCArmor((Inventory)npc.inventory, 0, 9, 22, EquipmentSlot.field_6169));
        this.addSlot(new SlotNPCArmor((Inventory)npc.inventory, 1, 9, 40, EquipmentSlot.field_6174));
        this.addSlot(new SlotNPCArmor((Inventory)npc.inventory, 2, 9, 58, EquipmentSlot.field_6172));
        this.addSlot(new SlotNPCArmor((Inventory)npc.inventory, 3, 9, 76, EquipmentSlot.field_6166));
