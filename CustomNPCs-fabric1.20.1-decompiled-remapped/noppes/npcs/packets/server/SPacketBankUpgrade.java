...
extends PacketServerBasic {
    ...
    public static void encode(SPacketBankUpgrade msg, PacketByteBuf buf) {
    }

    public static SPacketBankUpgrade decode(PacketByteBuf buf) {
    ...
    protected void handle() {
        ...
        ItemStack item = bank.upgradeInventory.getStack(container.slot);
        ...
        RoleEvent.BankUpgradedEvent event = new RoleEvent.BankUpgradedEvent((PlayerEntity)this.player, this.npc.wrappedNPC, container.slot);
