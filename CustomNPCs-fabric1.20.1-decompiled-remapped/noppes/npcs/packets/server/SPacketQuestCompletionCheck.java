...
extends PacketServerBasic {
    ...
    protected void handle() {
        ...
        if (event.expReward > 0) {
            NoppesUtilServer.playSound((LivingEntity)this.player, SoundEvents.field_14627, 0.1f, 0.5f * ((this.player.getWorld().random.nextFloat() - this.player.getWorld().random.nextFloat()) * 0.7f + 1.8f));
