...
ServerLifecycleEvents.ServerStarted {
    ...
    public void onInitialize() {
        ...
        CustomNpcs.setPrivateValue(ClampedEntityAttribute.class, (ClampedEntityAttribute)EntityAttributes.field_23716, Double.MAX_VALUE, 1);
            ...
            board.addUpdateListener(() -> {
                for (String objective : Availability.scores) {
                    ...
                    for (ServerPlayerEntity player : Server.getPlayerManager().getPlayerList()) {
                        ...
                        Map map = mixin.getScores().computeIfAbsent(player.getEntityName(), p_197898_0_ -> Maps.newHashMap());
