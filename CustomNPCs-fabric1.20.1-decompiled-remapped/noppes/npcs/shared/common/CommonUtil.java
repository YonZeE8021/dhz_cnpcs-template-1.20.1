...
public class CommonUtil {
    ...
    public static void NotifyOPs(MinecraftServer server, Text message) {
        MutableText chatcomponenttranslation = Text.literal((String)"").append(message).formatted(new Formatting[]{Formatting.field_1080, Formatting.field_1056});
        ...
        if (server.getWorld(World.OVERWORLD).getGameRules().getBoolean(GameRules.field_19397)) {
