...
public class NopModelPart {
    ...
    public void render(MatrixStack p_228309_1_, VertexConsumer p_228309_2_, int p_228309_3_, int p_228309_4_, float p_228309_5_, float p_228309_6_, float p_228309_7_, float p_228309_8_) {
        if (!(!this.visible || this.cubes.isEmpty() && this.children.isEmpty())) {
            ...
            this.compile(p_228309_1_.peek(), p_228309_2_, p_228309_3_, p_228309_4_, p_228309_5_, p_228309_6_, p_228309_7_, p_228309_8_);
    ...
    public void translateAndRotate(MatrixStack p_228307_1_) {
        ...
        if (this.zRot != 0.0f) {
            p_228307_1_.multiply(RotationAxis.POSITIVE_Z.rotation(this.zRot));
        }
        if (this.yRot != 0.0f) {
            p_228307_1_.multiply(RotationAxis.POSITIVE_Y.rotation(this.yRot));
        }
        if (this.xRot != 0.0f) {
            p_228307_1_.multiply(RotationAxis.POSITIVE_X.rotation(this.xRot));
        }
        p_228307_1_.scale(this.scale.x, this.scale.y, this.scale.z);
    }

    private void compile(MatrixStack.Entry p_228306_1_, VertexConsumer p_228306_2_, int p_228306_3_, int p_228306_4_, float p_228306_5_, float p_228306_6_, float p_228306_7_, float p_228306_8_) {
        Matrix4f matrix4f = p_228306_1_.getPositionMatrix();
        Matrix3f matrix3f = p_228306_1_.getNormalMatrix();
    ...
    public static class ModelBox {
        ...
        public ModelBox(int p_i225950_1_, int p_i225950_2_, float p_i225950_3_, float p_i225950_4_, float p_i225950_5_, float p_i225950_6_, float p_i225950_7_, float p_i225950_8_, float p_i225950_9_, float p_i225950_10_, float p_i225950_11_, boolean p_i225950_12_, float p_i225950_13_, float p_i225950_14_) {
            ...
            this.polygons[2] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex4, MpmModelPart$positiontexturevertex3, MpmModelPart$positiontexturevertex7, MpmModelPart$positiontexturevertex}, f5, f10, f6, f11, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.field_11033);
            this.polygons[3] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex1, MpmModelPart$positiontexturevertex2, MpmModelPart$positiontexturevertex6, MpmModelPart$positiontexturevertex5}, f6, f11, f7, f10, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.field_11036);
            this.polygons[1] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex7, MpmModelPart$positiontexturevertex3, MpmModelPart$positiontexturevertex6, MpmModelPart$positiontexturevertex2}, f4, f11, f5, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.field_11039);
            this.polygons[4] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex, MpmModelPart$positiontexturevertex7, MpmModelPart$positiontexturevertex2, MpmModelPart$positiontexturevertex1}, f5, f11, f6, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.field_11043);
            this.polygons[0] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex4, MpmModelPart$positiontexturevertex, MpmModelPart$positiontexturevertex1, MpmModelPart$positiontexturevertex5}, f6, f11, f8, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.field_11034);
            this.polygons[5] = new TexturedQuad(new PositionTextureVertex[]{MpmModelPart$positiontexturevertex3, MpmModelPart$positiontexturevertex4, MpmModelPart$positiontexturevertex5, MpmModelPart$positiontexturevertex6}, f8, f11, f9, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.field_11035);
        }
    }
