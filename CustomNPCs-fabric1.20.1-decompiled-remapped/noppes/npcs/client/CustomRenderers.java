...
public class CustomRenderers {
    ...
    public static void registerEntityRenderer() {
        ...
        EntityRendererRegistry.register(CustomEntities.entityCustomNpc, manager -> new RenderCustomNpc(manager, new PlayerEntityModel(manager.getModelLoader().getModelPart(EntityModelLayers.field_27577), false)));
        EntityRendererRegistry.register(CustomEntities.entityNPC64x32, manager -> new RenderCustomNpc(manager, new ModelPlayer64x32(manager.getModelLoader().getModelPart(EntityModelLayers.field_27577))));
        ...
        EntityRendererRegistry.register(CustomEntities.entityNpcAlex, manager -> new RenderCustomNpc(manager, new PlayerEntityModel(manager.getModelLoader().getModelPart(EntityModelLayers.field_27581), true)));
        EntityRendererRegistry.register(CustomEntities.entityNpcClassicPlayer, manager -> new RenderCustomNpc(manager, new ModelClassicPlayer(manager.getModelLoader().getModelPart(EntityModelLayers.field_27577), 0.0f)));
