...
extends AbstractTab {
    private Text displayString = Text.translatable((String)"menu.factions");

    public InventoryTabFactions() {
        super(1, 0, 0, new ItemStack((ItemConvertible)Items.field_8586, 1));
    }

    @Override
    public void onTabClicked() {
        MinecraftClient mc = MinecraftClient.getInstance();
        mc.setScreen((Screen)new GuiFaction());
    }
