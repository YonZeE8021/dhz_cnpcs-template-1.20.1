...
IGuiClose {
    ...
    public GuiMailmanWrite(ContainerMail container, PlayerInventory inv, Text titleIn) {
        ...
        if (this.bookPages != null) {
            ...
            this.bookPages.add((Object)NbtString.of((String)""));
            this.bookTotalPages = 1;
        }
    ...
    private void append(String par1Str) {
        ...
        int i = this.mc.textRenderer.getWrappedLinesHeight(s2 + String.valueOf(Formatting.field_1074) + "_", 118);
    ...
    public void render(DrawContext graphics, int mouseX, int mouseY, float par3) {
        ...
        if (this.canEdit) {
            s1 = this.updateCount / 6 % 2 == 0 ? (String)s1 + "_" : (this.updateCount / 6 % 2 == 0 ? (String)s1 + String.valueOf(Formatting.field_1074) + "_" : (String)s1 + String.valueOf(Formatting.field_1080) + "_");
        }
