...
extends GuiNPCInterface {
    ...
    private void addExperience(int exp) {
        ...
        this.getLabel(this.selected.id - 10).setMessage((Text)Text.literal((String)(String.valueOf(this.role.talents.get((Object)talent)) + "/" + this.role.getNextLevel(talent))));
    }
    ...
    extends Screen {
        ...
        public void render(DrawContext graphics, int mouseX, int mouseY, float partialTicks) {
            ...
            if (item.getItem() == null) {
                item = new ItemStack((ItemConvertible)Blocks.field_10566);
            }
            matrixStack.push();
            RenderSystem.setShaderColor((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
