...
ICustomScrollListener {
    ...
    public void initButtons() {
        ...
        if (this.selection == EnumPlayerData.Players) {
            this.getLabel(0).setMessage((Text)Text.translatable((String)"playerdata.allPlayers"));
        } else {
            this.getLabel(0).setMessage((Text)Text.translatable((String)"playerdata.selectedPlayer", (Object[])new Object[]{this.selectedPlayer}));
        }
    }
