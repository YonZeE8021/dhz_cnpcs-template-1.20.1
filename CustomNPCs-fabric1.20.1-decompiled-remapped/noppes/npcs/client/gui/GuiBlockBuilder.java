...
BooleanConsumer {
    ...
    public void init() {
        ...
        if (this.selected != null) {
            ...
            this.addButton(new GuiButtonYesNo((IGuiInterface)this, 3, this.guiLeft + 200, y, TileBuilder.DrawPos != null && this.tile.getPos().equals((Object)TileBuilder.DrawPos)));
    ...
    public void setGuiData(final NbtCompound compound) {
        if (compound.contains("Width")) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                states.add(NbtHelper.toBlockState((RegistryEntryLookup)this.player.getWorld().createCommandRegistryWrapper(RegistryKeys.field_41254), (NbtCompound)list.getCompound(i)));
            }
