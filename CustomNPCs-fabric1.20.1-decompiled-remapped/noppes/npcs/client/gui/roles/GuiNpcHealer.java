...
extends GuiNPCInterface2 {
    ...
    public GuiNpcHealer(EntityNPCInterface npc) {
        ...
        Registry r = Registries.STATUS_EFFECT;
        for (Identifier rl : r.getIds()) {
            this.potions.put(rl.toString(), r.getRawId((Object)((StatusEffect)r.get(rl))));
        }
    }
    ...
    public void init() {
        ...
        for (String names : this.potions.keySet()) {
            ...
            this.displays.put(I18n.translate((String)names, (Object[])new Object[0]) + " " + I18n.translate((String)("enchantment.level." + (this.job.effects.get(this.potions.get(names)) + 1)), (Object[])new Object[0]), names);
        }
    ...
    public void buttonEvent(GuiButtonNop guibutton) {
        ...
        if (button.id == 13) {
            ...
            Registry r = Registries.STATUS_EFFECT;
            for (Identifier rl : r.getIds()) {
                this.job.effects.put(r.getRawId((Object)((StatusEffect)r.get(rl))), this.potency);
            }
            this.scroll1.clearSelection();
            this.scroll2.clearSelection();
            this.init();
