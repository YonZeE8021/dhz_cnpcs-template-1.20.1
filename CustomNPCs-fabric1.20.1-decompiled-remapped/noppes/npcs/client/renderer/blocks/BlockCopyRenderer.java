...
extends BlockRendererInterface<TileCopy> {
    ...
    public void render(TileCopy tile, float partialTicks, MatrixStack matrixStack, VertexConsumerProvider buffer, int light, int overlay) {
        ...
        MinecraftClient.getInstance().getItemRenderer().renderItem(item, ModelTransformationMode.field_4315, light, OverlayTexture.DEFAULT_UV, matrixStack, buffer, null, 0);
        matrixStack.pop();
    }
