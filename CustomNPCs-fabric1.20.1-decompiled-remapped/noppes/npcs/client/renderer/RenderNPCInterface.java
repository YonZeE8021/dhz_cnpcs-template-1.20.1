...
extends LivingEntityRenderer<T, M> {
    ...
    public void renderNameTag(T npc, Text text, MatrixStack matrixStack, VertexConsumerProvider buffer, int light) {
        if (npc == null || !this.hasLabel((LivingEntity)npc) || this.dispatcher == null) {
            return;
        }
        ...
        matrixStack.push();
        Vec3d renderOffset = this.getPositionOffset((Entity)npc, 0.0f);
        ...
        if (((EntityNPCInterface)((Object)npc)).messages != null) {
            ...
            float offset = npc.getHeight() * (1.2f + (!((EntityNPCInterface)((Object)npc)).display.showName() ? 0.0f : (((EntityNPCInterface)((Object)npc)).display.getTitle().isEmpty() ? 0.15f : 0.25f)));
            matrixStack.translate(0.0f, offset, 0.0f);
            ((EntityNPCInterface)((Object)npc)).messages.renderMessages(matrixStack, buffer, 0.666667f * height, ((EntityNPCInterface)((Object)npc)).isInRange(this.dispatcher.camera.getFocusedEntity(), 4.0), light);
            matrixStack.translate(0.0f, -offset, 0.0f);
        }
    ...
    protected void renderLivingLabel(T npc, MatrixStack matrixStack, VertexConsumerProvider buffer, int light) {
        ...
        float y = 0.0f;
        boolean nearby = ((EntityNPCInterface)((Object)npc)).isInRange(this.dispatcher.camera.getFocusedEntity(), 8.0);
        if (!((EntityNPCInterface)((Object)npc)).display.getTitle().isEmpty() && nearby) {
            MutableText title = Text.literal((String)"<").append((Text)Text.translatable((String)((EntityNPCInterface)((Object)npc)).display.getTitle())).append(">");
            float f3 = 0.6f;
            matrixStack.translate(0.0f, 4.0f, 0.0f);
            matrixStack.scale(f3, f3, f3);
            fontrenderer.draw((Text)title, (float)(-fontrenderer.getWidth((StringVisitable)title) / 2), 0.0f, color, false, matrix4f, buffer, TextRenderer.TextLayerType.field_33993, j, light);
            matrixStack.scale(1.0f / f3, 1.0f / f3, 1.0f / f3);
            y = -10.0f;
        }
        Text name = ((EntityNPCInterface)((Object)npc)).getName();
        fontrenderer.draw(name, (float)(-fontrenderer.getWidth((StringVisitable)name) / 2), y, color, false, matrix4f, buffer, nearby ? TextRenderer.TextLayerType.field_33994 : TextRenderer.TextLayerType.field_33993, j, light);
        if (nearby) {
            fontrenderer.draw(name, (float)(-fontrenderer.getWidth((StringVisitable)name) / 2), y, color, false, matrix4f, buffer, TextRenderer.TextLayerType.field_33993, 0, light);
        }
        matrixStack.pop();
    }
    ...
    protected void setupRotations(T npc, MatrixStack matrixScale, float f, float f1, float f2) {
        if (((EntityNPCInterface)((Object)npc)).isAlive() && ((EntityNPCInterface)((Object)npc)).isSleeping()) {
            matrixScale.multiply(RotationAxis.POSITIVE_Y.rotationDegrees((float)((EntityNPCInterface)((Object)npc)).ais.orientation));
            matrixScale.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(this.getLyingAngle((LivingEntity)npc)));
    ...
    public void render(T npc, float entityYaw, float partialTicks, MatrixStack matrixStack, VertexConsumerProvider buffer, int packedLight) {
        ...
        if (((EntityNPCInterface)((Object)npc)).isAlive()) {
            if (((EntityNPCInterface)((Object)npc)).isSleeping()) {
                ...
                yOffset += 0.14f;
            } else if (((EntityNPCInterface)((Object)npc)).currentAnimation == 1 || npc.hasVehicle()) {
        ...
        if (((EntityNPCInterface)((Object)npc)).display.getBossbar() != 1 && (((EntityNPCInterface)((Object)npc)).display.getBossbar() != 2 || !((EntityNPCInterface)((Object)npc)).isAttacking()) || ((EntityNPCInterface)((Object)npc)).isKilled() || ((EntityNPCInterface)((Object)npc)).deathTime > 20 || ((EntityNPCInterface)((Object)npc)).canNpcSee((Entity)MinecraftClient.getInstance().player)) {
            // empty if block
        }
        if (((EntityNPCInterface)((Object)npc)).ais.getStandingType() == 3 && !((EntityNPCInterface)((Object)npc)).isWalking() && !((EntityNPCInterface)((Object)npc)).isInteracting()) {
            ((EntityNPCInterface)((Object)npc)).prevBodyYaw = ((EntityNPCInterface)((Object)npc)).bodyYaw = (float)((EntityNPCInterface)((Object)npc)).ais.orientation;
        }
    ...
    public Identifier getTextureLocation(T npc) {
        if (((EntityNPCInterface)((Object)npc)).textureLocation == null) {
            if (((EntityNPCInterface)((Object)npc)).display.skinType == 0) {
                ((EntityNPCInterface)((Object)npc)).textureLocation = new Identifier(((EntityNPCInterface)((Object)npc)).display.getSkinTexture());
            } else {
                ...
                if (((EntityNPCInterface)((Object)npc)).display.skinType == 1 && ((EntityNPCInterface)((Object)npc)).display.playerProfile != null) {
                    ...
                    Map map = minecraft.getSkinProvider().getTextures(((EntityNPCInterface)((Object)npc)).display.playerProfile);
                    ((EntityNPCInterface)((Object)npc)).textureLocation = map.containsKey(MinecraftProfileTexture.Type.SKIN) ? minecraft.getSkinProvider().loadSkin((MinecraftProfileTexture)map.get(MinecraftProfileTexture.Type.SKIN), MinecraftProfileTexture.Type.SKIN) : DefaultSkinHelper.getTexture((UUID)Uuids.getUuidFromProfile((GameProfile)((EntityNPCInterface)((Object)npc)).display.playerProfile));
