...
public class MusicController {
    ...
    public void stopMusic() {
        ...
        handler.stopSounds(null, SoundCategory.field_15253);
        handler.stopSounds(null, SoundCategory.field_15256);
        handler.stopSounds(null, SoundCategory.field_15247);
    ...
    public void playStreaming(String music, Entity entity, boolean isLooping) {
        ...
        SoundManager handler = MinecraftClient.getInstance().getSoundManager();
        this.playing = new PositionedSoundInstance(this.playingResource, SoundCategory.field_15247, 4.0f, 1.0f, SoundInstance.createRandom(), isLooping, 0, SoundInstance.AttenuationType.field_5476, entity.getX(), entity.getY(), entity.getZ(), false);
    ...
    public void playMusic(String music, Entity entity, boolean isLooping) {
        ...
        this.playingEntity = entity;
        SoundManager handler = MinecraftClient.getInstance().getSoundManager();
        this.playing = new PositionedSoundInstance(this.playingResource, SoundCategory.field_15253, 1.0f, 1.0f, SoundInstance.createRandom(), isLooping, 0, SoundInstance.AttenuationType.field_5478, 0.0, 0.0, 0.0, false);
        handler.play(this.playing);
    }
    ...
    public void playSound(SoundCategory cat, String music, BlockPos pos, float volume, float pitch) {
        PositionedSoundInstance rec = new PositionedSoundInstance(new Identifier(music), cat, volume, pitch, SoundInstance.createRandom(), false, 0, SoundInstance.AttenuationType.field_5476, (double)((float)pos.getX() + 0.5f), (double)pos.getY(), (double)((float)pos.getZ() + 0.5f), false);
