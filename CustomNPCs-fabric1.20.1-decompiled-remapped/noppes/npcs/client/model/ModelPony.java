...
extends EntityModel<T> {
    ...
    public void setupAnim(T npc, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float f6;
        Resource resource;
        if (((EntityNpcPony)((Object)npc)).textureLocation != ((EntityNpcPony)((Object)npc)).checked && ((EntityNpcPony)((Object)npc)).textureLocation != null && (resource = (Resource)MinecraftClient.getInstance().getResourceManager().getResource(((EntityNpcPony)((Object)npc)).textureLocation).orElse(null)) != null) {
            try {
        ...
        this.isSleeping = ((EntityNPCInterface)((Object)npc)).isSleeping();
        this.isUnicorn = ((EntityNpcPony)((Object)npc)).isUnicorn;
        this.isPegasus = ((EntityNpcPony)((Object)npc)).isPegasus;
        this.isSneak = ((EntityNPCInterface)((Object)npc)).isInSneakingPose();
        this.heldItemRight = ((EntityNPCInterface)((Object)npc)).getMainHandStack() == null ? 0 : 1;
