...
public class EntityUtil {
    ...
    public static void Copy(LivingEntity copied, LivingEntity entity) {
        ...
        for (DataTracker.Entry<?> entry : copiedData) {
            ...
            entity.getDataTracker().set(entry.getData(), ((DataTracker.SerializedEntry)entry.get()).comp_1117());
        }
        ...
        for (PlayerEntity class_16572 : EquipmentSlot.values()) {
            entity.equipStack((EquipmentSlot)class_16572, copied.getEquippedStack((EquipmentSlot)class_16572));
        }
        ...
        for (EntityType ent : Registries.ENTITY_TYPE) {
            try {
                ...
                if (LivingEntity.class.isAssignableFrom(e.getClass()) && (withNpcs || !EntityNPCInterface.class.isAssignableFrom(e.getClass()))) {
                    data.put(ent.getTranslationKey(), Registries.ENTITY_TYPE.getId((Object)ent));
                }
                e.discard();
            }
            catch (Throwable e) {
