...
extends LayerInterface {
    ...
    public void render(MatrixStack mStack, VertexConsumerProvider typeBuffer, int lightmapUV, float limbSwing, float limbSwingAmount, float partialTicks, float age, float netHeadYaw, float headPitch) {
        ...
        minecraft.getItemRenderer().renderItem((LivingEntity)this.npc, itemstack, ModelTransformationMode.field_4315, false, mStack, typeBuffer, this.npc.getWorld(), lightmapUV, LivingEntityRenderer.getOverlay((LivingEntity)this.npc, (float)0.0f), 0);
        mStack.pop();
    }
