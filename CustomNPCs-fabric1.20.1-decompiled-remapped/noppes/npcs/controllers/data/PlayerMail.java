...
Inventory {
    ...
    public DefaultedList<ItemStack> items = DefaultedList.ofSize((int)4, (Object)ItemStack.EMPTY);
    ...
    public void readNBT(NbtCompound compound) {
        ...
        for (int i = 0; i < nbttaglist.size(); ++i) {
            ...
            this.items.set(j, (Object)ItemStack.fromNbt((NbtCompound)nbttagcompound1));
        }
    }
