...
implements IFaction {
    ...
    public NbtCompound writeNBT(NbtCompound compound) {
        ...
        compound.put("AttackFactions", (NbtElement)NBTTags.nbtIntegerCollection(this.attackFactions));
        return compound;
    }
    ...
    public int playerStatus(IPlayer player) {
        ...
        int points = data.getFactionPoints((PlayerEntity)player.getMCEntity(), this.id);
