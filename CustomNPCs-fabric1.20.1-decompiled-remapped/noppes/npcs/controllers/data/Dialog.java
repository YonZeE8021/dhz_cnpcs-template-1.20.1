...
IDialog {
    ...
    public NbtCompound writeToNBTPartial(NbtCompound compound) {
        ...
        compound.put("DialogMail", (NbtElement)this.mail.writeNBT());
        ...
        for (int opslot : this.options.keySet()) {
            ...
            listcompound.put("Option", (NbtElement)this.options.get(opslot).writeNBT());
            options.add((Object)listcompound);
        }
        compound.put("Options", (NbtElement)options);
