...
implements ISchematic {
    ...
    private Map<Integer, BlockState> readPalette(NbtCompound comp, int dataVersion) {
        ...
        for (String blockState : comp.getKeys()) {
            ...
            if (dataVersion < 2586) {
                ...
                Dynamic dynamic = new Dynamic((DynamicOps)NbtOps.INSTANCE, (Object)stateNBT);
        ...
        while (iterator.hasNext()) {
            ...
            palette.put(id, Blocks.field_10124.getDefaultState());
        }
        return palette;
    }
    ...
    private List<NbtCompound> readTileData(NbtList list, int dataVersion) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            data.remove("Pos");
            if (dataVersion < 2586) {
                Dynamic dynamic = new Dynamic((DynamicOps)NbtOps.INSTANCE, (Object)data);
