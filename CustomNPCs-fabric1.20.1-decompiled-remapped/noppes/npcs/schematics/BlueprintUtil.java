...
public class BlueprintUtil {
    public static NbtCompound writeBlueprintToNBT(Blueprint schem) {
        ...
        for (short i = 0; i < schem.getPalleteSize(); i = (short)(i + 1)) {
            paletteTag.add((Object)NbtHelper.fromBlockState((BlockState)palette[i]));
        }
        ...
        for (int i = 0; i < requiredMods.size(); ++i) {
            modsList.add((Object)NbtString.of((String)requiredMods.get(i)));
        }
        ...
        if (architects != null) {
            ...
            for (String architect : architects) {
                architectsTag.add((Object)NbtString.of((String)architect));
            }
