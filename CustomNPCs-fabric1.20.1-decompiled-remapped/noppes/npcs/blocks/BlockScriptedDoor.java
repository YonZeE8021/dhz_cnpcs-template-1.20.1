...
extends BlockNpcDoorInterface {
    public BlockScriptedDoor() {
        super(AbstractBlock.Settings.copy((AbstractBlock)Blocks.field_9973).strength(5.0f, 10.0f));
    }
    ...
    public ActionResult onUse(BlockState state, World level, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult ray) {
        ...
        BlockPos blockpos1 = state.get((Property)HALF) == DoubleBlockHalf.field_12607 ? pos : pos.down();
        BlockState class_26802 = iblockstate1 = pos.equals((Object)blockpos1) ? state : level.getBlockState(blockpos1);
    ...
    public void neighborUpdate(BlockState state, World worldIn, BlockPos pos, Block neighborBlock, BlockPos pos2, boolean isMoving) {
        if (state.get((Property)HALF) == DoubleBlockHalf.field_12609) {
    ...
    public void onBreak(World level, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        BlockPos blockpos1 = state.get((Property)HALF) == DoubleBlockHalf.field_12607 ? pos : pos.down();
        BlockState class_26802 = iblockstate1 = pos.equals((Object)blockpos1) ? state : level.getBlockState(blockpos1);
        if (player.getAbilities().creativeMode && iblockstate1.get((Property)HALF) == DoubleBlockHalf.field_12607 && iblockstate1.getBlock() == this) {
