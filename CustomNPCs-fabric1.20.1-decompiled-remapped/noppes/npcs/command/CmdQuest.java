...
public class CmdQuest {
    public static LiteralArgumentBuilder<ServerCommandSource> register() {
        LiteralArgumentBuilder command = CommandManager.literal((String)"quest");
        command.then(CommandManager.literal((String)"start").then(((RequiredArgumentBuilder)CommandManager.argument((String)"players", (ArgumentType)EntityArgumentType.players()).requires(source -> source.hasPermissionLevel(2))).then(CommandManager.argument((String)"quest", (ArgumentType)IntegerArgumentType.integer((int)0)).executes(context -> {
            Collection players = EntityArgumentType.getPlayers((CommandContext)context, (String)"players");
            if (players.isEmpty()) {
                return 1;
            }
        ...
        command.then(CommandManager.literal((String)"finish").then(((RequiredArgumentBuilder)CommandManager.argument((String)"players", (ArgumentType)EntityArgumentType.players()).requires(source -> source.hasPermissionLevel(2))).then(CommandManager.argument((String)"quest", (ArgumentType)IntegerArgumentType.integer((int)0)).executes(context -> {
            Collection players = EntityArgumentType.getPlayers((CommandContext)context, (String)"players");
            if (players.isEmpty()) {
                return 1;
            }
        ...
        command.then(CommandManager.literal((String)"stop").then(((RequiredArgumentBuilder)CommandManager.argument((String)"players", (ArgumentType)EntityArgumentType.players()).requires(source -> source.hasPermissionLevel(2))).then(CommandManager.argument((String)"quest", (ArgumentType)IntegerArgumentType.integer((int)0)).executes(context -> {
            Collection players = EntityArgumentType.getPlayers((CommandContext)context, (String)"players");
            if (players.isEmpty()) {
                return 1;
            }
        ...
        command.then(CommandManager.literal((String)"remove").then(((RequiredArgumentBuilder)CommandManager.argument((String)"players", (ArgumentType)EntityArgumentType.players()).requires(source -> source.hasPermissionLevel(2))).then(CommandManager.argument((String)"quest", (ArgumentType)IntegerArgumentType.integer((int)0)).executes(context -> {
            Collection players = EntityArgumentType.getPlayers((CommandContext)context, (String)"players");
            if (players.isEmpty()) {
                return 1;
            }
        ...
        command.then(CommandManager.literal((String)"objective").then(((RequiredArgumentBuilder)CommandManager.argument((String)"players", (ArgumentType)EntityArgumentType.players()).requires(source -> source.hasPermissionLevel(2))).then(((RequiredArgumentBuilder)CommandManager.argument((String)"quest", (ArgumentType)IntegerArgumentType.integer((int)0)).executes(context -> {
            Collection players = EntityArgumentType.getPlayers((CommandContext)context, (String)"players");
            if (players.isEmpty()) {
                return 1;
            }
        ...
        ((LiteralArgumentBuilder)command.requires(source -> source.hasPermissionLevel(4))).then(CommandManager.literal((String)"reload").executes(context -> {
