...
extends StateNode {
    ...
    public String toString(int level) {
        ...
        value.append("\n  target: ").append(QuantifierNode.pad(this.target, level + 1));
        value.append("\n  lower: ").append(this.lower);
        value.append("\n  upper: ").append(this.upper);
        value.append("\n  greedy: ").append(this.greedy);
        value.append("\n  targetEmptyInfo: ").append(this.targetEmptyInfo);
        value.append("\n  headExact: ").append(QuantifierNode.pad(this.headExact, level + 1));
        value.append("\n  nextHeadExact: ").append(QuantifierNode.pad(this.nextHeadExact, level + 1));
