...
extends SpillProperty {
    ...
    private static MethodHandle getObjectGetterInvoker() {
        return Context.getGlobal().getDynamicInvoker(OBJECT_GETTER_INVOKER_KEY, () -> UserAccessorProperty.getINVOKE_UA_GETTER(Object.class, -1));
    }
    ...
    private static MethodHandle getObjectSetterInvoker() {
        return Context.getGlobal().getDynamicInvoker(OBJECT_SETTER_INVOKER_KEY, () -> UserAccessorProperty.getINVOKE_UA_SETTER(Object.class));
    }

    static MethodHandle getINVOKE_UA_SETTER(Class<?> valueType) {
        return Bootstrap.createDynamicCallInvoker(Void.TYPE, Object.class, Object.class, valueType);
    }
    ...
    public void setValue(ScriptObject self, ScriptObject owner, Object value, boolean strict) {
        try {
            UserAccessorProperty.invokeObjectSetter(this.getAccessors(owner != null ? owner : self), UserAccessorProperty.getObjectSetterInvoker(), strict ? this.getKey().toString() : null, self, value);
        }
        catch (Error | RuntimeException t) {
            throw t;
        }
