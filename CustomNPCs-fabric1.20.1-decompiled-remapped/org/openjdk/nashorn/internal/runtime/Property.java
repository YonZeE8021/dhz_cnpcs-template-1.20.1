...
implements Serializable {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder();
        Class<?> t = this.getLocalType();
        sb.append(Property.indent(this.getKey().toString(), 20)).append(" id=").append(Debug.id(this)).append(" (0x").append(Property.indent(Integer.toHexString(this.flags), 4)).append(") ").append(this.getClass().getSimpleName()).append(" {").append(Property.indent(Property.type(t), 5)).append('}');
        if (this.slot != -1) {
