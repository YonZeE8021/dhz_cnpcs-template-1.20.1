...
import org.openjdk.nashorn.internal.objects.NativeUint8Array$Prototype;
...
extends ScriptFunction {
    ...
    NativeUint8Array$Constructor() {
        ...
        this.setArity(1);
        this.setDocumentationKey("Uint8Array");
    }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(NativeUint8Array.class, "constructor", MethodType.fromMethodDescriptorString("(ZLjava/lang/Object;[Ljava/lang/Object;)Lorg/openjdk/nashorn/internal/objects/NativeUint8Array;", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
