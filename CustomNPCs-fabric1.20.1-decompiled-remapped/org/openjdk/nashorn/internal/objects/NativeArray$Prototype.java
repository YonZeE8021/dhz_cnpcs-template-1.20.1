...
extends PrototypeObject {
    ...
    static {
        ArrayList<Property> arrayList = new ArrayList<Property>(27);
        ...
        arrayList.add(AccessorProperty.create("entries", 2, cfr_ldc_46(), cfr_ldc_47()));
        arrayList.add(AccessorProperty.create("keys", 2, cfr_ldc_48(), cfr_ldc_49()));
        arrayList.add(AccessorProperty.create("values", 2, cfr_ldc_50(), cfr_ldc_51()));
        arrayList.add(AccessorProperty.create(NativeSymbol.iterator, 2, cfr_ldc_52(), cfr_ldc_53()));
