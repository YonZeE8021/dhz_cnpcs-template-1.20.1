    ...
    public String toString() {
        ...
        for (int i = 0; i < this.sp; ++i) {
            ...
            if (node instanceof FunctionNode) {
                ...
                Object src = source.toString();
                if (((String)src).contains(File.pathSeparator)) {
                    src = ((String)src).substring(((String)src).lastIndexOf(File.pathSeparator));
                }
                src = (String)src + " ";
                src = (String)src + fn.getLineNumber();
