...
implements INPCAi {
    ...
    public void setWalkingSpeed(int speed) {
        ...
        this.npc.getAttributeInstance(EntityAttributes.GENERIC_MOVEMENT_SPEED).setBaseValue((double)this.npc.getMovementSpeed());
        this.npc.getAttributeInstance(EntityAttributes.GENERIC_FLYING_SPEED).setBaseValue((double)(this.npc.getMovementSpeed() * 2.0f));
    }
    ...
    public void setAvoidsWater(boolean enabled) {
        this.npc.setPathfindingPenalty(PathNodeType.WATER, this.movementType != 2 && enabled ? -1.0f : 0.0f);
