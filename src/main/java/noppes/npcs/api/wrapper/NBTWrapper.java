...
implements INbt {
    ...
    public void setList(String key, Object[] value) {
        ...
        for (Object nbt : value) {
            ...
            if (nbt instanceof String) {
                list.add(NbtString.of((String)((String)nbt)));
                continue;
            }
            if (nbt instanceof Double) {
                list.add(NbtDouble.of((double)((Double)nbt)));
                continue;
            }
            if (nbt instanceof Float) {
                list.add(NbtFloat.of((float)((Float)nbt).floatValue()));
                continue;
            }
            if (nbt instanceof Integer) {
                list.add(NbtInt.of((int)((Integer)nbt)));
                continue;
            }
            if (!(nbt instanceof int[])) continue;
            list.add(new NbtIntArray((int[])nbt));
        }
    ...
    public boolean isEqual(INbt nbt) {
        ...
        return this.compound.equals(nbt.getMCNBT());
    }
