...
implements IEntityLiving {
    ...
    public void setMaxHealth(float health) {
        ...
        ((LivingEntity)this.entity).getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue((double)health);
    }
    ...
    public void swingMainhand() {
        ((LivingEntity)this.entity).swingHand(Hand.MAIN_HAND);
    }

    @Override
    public void swingOffhand() {
        ((LivingEntity)this.entity).swingHand(Hand.OFF_HAND);
    }
    ...
    public void setMainhandItem(IItemStack item) {
        ((LivingEntity)this.entity).setStackInHand(Hand.MAIN_HAND, item == null ? ItemStack.EMPTY : item.getMCItemStack());
    }
    ...
    public void setOffhandItem(IItemStack item) {
        ((LivingEntity)this.entity).setStackInHand(Hand.OFF_HAND, item == null ? ItemStack.EMPTY : item.getMCItemStack());
    }
