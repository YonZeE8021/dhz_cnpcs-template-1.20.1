...
ICustomScrollListener {
    ...
    public void init() {
        ...
        if (this.job.animate) {
            ...
            this.getButton((int)67).active = !this.isStart;
            this.getButton((int)68).active = this.isStart;
        }
    }
    ...
    public void buttonEvent(GuiButtonNop btn) {
        ...
        if (btn.id == 29) {
            boolean bl = this.data.get(this.selectedName).disabled = button.getValue() == 1;
        }
        if (btn.id == 30) {
