...
ICustomScrollListener {
    ...
    public void init() {
        ...
        if (this.data.containsValue(this.options.factionId)) {
            ...
            label = "";
            label = this.options.decreaseFactionPoints ? (String)label + I18n.translate((String)"gui.decrease", (Object[])new Object[0]) : (String)label + I18n.translate((String)"gui.increase", (Object[])new Object[0]);
            label = (String)label + " " + this.options.factionPoints + " " + I18n.translate((String)"faction.points", (Object[])new Object[0]);
        ...
        if (this.data.containsValue(this.options.faction2Id)) {
            ...
            label = "";
            label = this.options.decreaseFaction2Points ? (String)label + I18n.translate((String)"gui.decrease", (Object[])new Object[0]) : (String)label + I18n.translate((String)"gui.increase", (Object[])new Object[0]);
            label = (String)label + " " + this.options.faction2Points + " " + I18n.translate((String)"faction.points", (Object[])new Object[0]);
