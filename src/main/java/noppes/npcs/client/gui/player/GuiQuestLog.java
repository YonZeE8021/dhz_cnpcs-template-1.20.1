...
ICustomScrollListener {
    ...
    public void init() {
        ...
        this.guiTop += 10;
        this.addDrawableChild(new InventoryTabVanilla().init(this));
        this.addDrawableChild(new InventoryTabFactions().init(this));
        this.addDrawableChild(new InventoryTabQuests().init(this));
        this.noQuests = false;
        ...
        this.sideButtons.get(Integer.valueOf((int)categories.indexOf(this.selectedCategory.getString()))).active = true;
        if (this.scroll == null) {
