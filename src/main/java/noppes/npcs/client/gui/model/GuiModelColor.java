...
implements ITextfieldListener {
    ...
    public GuiModelColor(GuiCustom parent, int c, ColorCallback callback) {
        ...
        this.button = new CustomGuiButton(this, (CustomGuiButtonWrapper)((CustomGuiComponentWrapper)(new CustomGuiButtonWrapper(66, "x", 107, 8, 20, 20).setOnPress((gui, button) -> {
            parent.subgui = null;
        }))).setDisablePackets());
