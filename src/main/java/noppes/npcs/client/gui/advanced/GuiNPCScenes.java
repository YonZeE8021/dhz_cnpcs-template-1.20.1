    ...
    public void init() {
        ...
        for (int i = 0; i < this.scenes.scenes.size(); ++i) {
            ...
            if (CustomNpcs.SceneButtonsEnabled) {
                this.addButton(new GuiButtonNop((IGuiInterface)this, 4 + i * 10, this.guiLeft + 232, y, 60, 20, new String[]{"gui.none", ClientProxy.Scene1.getTranslationKey(), ClientProxy.Scene2.getTranslationKey(), ClientProxy.Scene3.getTranslationKey()}, scene.btn));
            }
            y += 22;
        }
