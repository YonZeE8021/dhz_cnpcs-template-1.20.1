...
GuiSelectionListener {
    ...
    public void init() {
        ...
        if (this.player.currentScreenHandler instanceof ContainerMail) {
            ContainerMail container = (ContainerMail)this.player.currentScreenHandler;
    ...
    public void buttonEvent(GuiButtonNop guibutton) {
        ...
        if (id == 1) {
            this.mail.questId = -1;
            this.mail.message = new NbtCompound();
            this.close();
        }
        if (id == 2) {
