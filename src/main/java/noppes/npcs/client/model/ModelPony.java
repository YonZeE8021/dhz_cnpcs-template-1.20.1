...
extends EntityModel<T> {
    ...
    @Override
    public void setAngles(T npc, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float f11;
        float f10;
        float f9;
        float f8;
        ...
        float f6;
        Resource resource;
        if (((EntityNpcPony)(npc)).textureLocation != ((EntityNpcPony)(npc)).checked && ((EntityNpcPony)(npc)).textureLocation != null && (resource = (Resource)MinecraftClient.getInstance().getResourceManager().getResource(((EntityNpcPony)(npc)).textureLocation).orElse(null)) != null) {
            try {
                BufferedImage bufferedimage = ImageIO.read(resource.getInputStream());
                ((EntityNpcPony)(npc)).isPegasus = false;
                ((EntityNpcPony)(npc)).isUnicorn = false;
                ...
                if (color.equals(color2)) {
                    ((EntityNpcPony)(npc)).isPegasus = true;
                }
                if (color.equals(color3)) {
                    ((EntityNpcPony)(npc)).isUnicorn = true;
                }
                if (color.equals(color4)) {
                    ((EntityNpcPony)(npc)).isPegasus = true;
                    ((EntityNpcPony)(npc)).isUnicorn = true;
                }
                ((EntityNpcPony)(npc)).checked = ((EntityNpcPony)(npc)).textureLocation;
            }
            catch (IOException bufferedimage) {
                // empty catch block
            }
        }
        this.isSleeping = ((EntityNPCInterface)(npc)).isSleeping();
        this.isUnicorn = ((EntityNpcPony)(npc)).isUnicorn;
        this.isPegasus = ((EntityNpcPony)(npc)).isPegasus;
        this.isSneak = ((EntityNPCInterface)(npc)).isInSneakingPose();
        this.heldItemRight = ((EntityNPCInterface)(npc)).getMainHandStack() == null ? 0 : 1;
        this.riding = npc.hasVehicle();
        if (this.isSneak && (((EntityNpcPony)(npc)).currentAnimation == 7 || ((EntityNpcPony)(npc)).currentAnimation == 2)) {
            this.isSneak = false;
        }
        this.rainboom = false;
        if (this.isSleeping) {
        ...
        if (!this.isFlying || !this.isPegasus) {
            f8 = MathHelper.cos((float)(limbSwing * 0.6662f + 3.141593f)) * 0.6f * limbSwingAmount;
            f9 = MathHelper.cos((float)(limbSwing * 0.6662f)) * 0.6f * limbSwingAmount;
            f10 = MathHelper.cos((float)(limbSwing * 0.6662f)) * 0.3f * limbSwingAmount;
            f11 = MathHelper.cos((float)(limbSwing * 0.6662f + 3.141593f)) * 0.3f * limbSwingAmount;
            ...
            if (limbSwingAmount < 0.9999f) {
                this.rainboom = false;
                f8 = MathHelper.sin((float)(0.0f - limbSwingAmount * 0.5f));
                f9 = MathHelper.sin((float)(0.0f - limbSwingAmount * 0.5f));
                f10 = MathHelper.sin((float)(limbSwingAmount * 0.5f));
                f11 = MathHelper.sin((float)(limbSwingAmount * 0.5f));
            } else {
                this.rainboom = true;
                f8 = 4.712f;
                f9 = 4.712f;
        ...
        for (int i = 0; i < this.Tail.length; ++i) {
            this.Tail[i].zRot = this.rainboom ? 0.0f : MathHelper.cos((float)(limbSwing * 0.8f)) * 0.2f * limbSwingAmount;
        }
        ...
        if (this.isSneak && !this.isFlying) {
            ...
            this.LeftLeg.y = 8.0f;
            float f36 = MathHelper.cos((float)(ageInTicks * 0.09f)) * 0.05f + 0.05f;
            float f39 = MathHelper.sin((float)(ageInTicks * 0.067f)) * 0.05f;
            this.unicornarm.zRot += f36;
            this.unicornarm.xRot += f39;
            if (this.isPegasus && this.isFlying) {
                this.WingRotateAngleY = MathHelper.sin((float)(ageInTicks * 0.067f * 8.0f)) * 1.0f;
                this.WingRotateAngleZ = MathHelper.sin((float)(ageInTicks * 0.067f * 8.0f)) * 1.0f;
            ...
            for (int k5 = 0; k5 < this.Tail.length; ++k5) {
                ...
                this.Tail[k5].y = f57;
                this.Tail[k5].z = f59;
                this.Tail[k5].xRot = this.rainboom ? 1.571f + 0.1f * MathHelper.sin((float)limbSwing) : f61;
            }
        ...
        if (this.aimedBow) {
            ...
            this.unicornarm.zRot += MathHelper.cos((float)(f31 * 0.09f)) * 0.05f + 0.05f;
            this.unicornarm.xRot += MathHelper.sin((float)(f31 * 0.067f)) * 0.05f;
            if (!this.isUnicorn) {
    ...
    public void render(MatrixStack mStack, VertexConsumer iVertex, int lightmapUV, int packedOverlayIn, float red, float green, float blue, float alpha) {
        mStack.push();
        if (this.isSleeping) {
            mStack.multiply(RotationAxis.POSITIVE_X.rotationDegrees(90.0f));
