...
extends RenderPhase {
    ...
    public static net.minecraft.client.gl.ShaderProgram posTexNormalShader;
    ...
    public static RenderLayer getObjRenderType(Identifier texture, int blending, boolean glow) {
        ...
        return RenderLayer.of((String)"lm_obj_translucent_no_cull", (VertexFormat)POS_COL_TEX_LIGHT_FADE_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.TRIANGLES, (int)256, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)renderTypeState);
    }
    ...
    public static RenderLayer getObjOutlineRenderType(Identifier texture) {
        ...
        return RenderLayer.of((String)"lm_obj_outline_no_cull", (VertexFormat)POS_COL_TEX_LIGHT_FADE_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.TRIANGLES, (int)256, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)renderTypeState);
    }
    ...
    public static RenderLayer getSpriteRenderType(Identifier texture) {
        ...
        return RenderLayer.of((String)"lm_sprite", (VertexFormat)POS_COL_TEX_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.QUADS, (int)256, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)renderTypeState);
    }

    static {
        POS_TEX_NORMAL = new VertexFormat(ImmutableMap.of("Position", VertexFormats.POSITION_ELEMENT, "UV0", VertexFormats.TEXTURE_ELEMENT, "Normal", VertexFormats.NORMAL_ELEMENT, "Padding", VertexFormats.PADDING_ELEMENT));
        ...
        for (BLEND blend : BLEND.values()) {
            for (int glow = 0; glow < 2; ++glow) {
                CustomRenderStates.OBJ_RENDER_TYPES[blend.id * 2 + glow] = RenderLayer.of((String)("lm_obj_" + blend.toString() + (glow == 1 ? "_glow" : "")), (VertexFormat)POS_TEX_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.TRIANGLES, (int)256, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)RenderLayer.MultiPhaseParameters.builder().transparency(blend == BLEND.ADD ? ADDITIVE_TRANSPARENCY : (blend == BLEND.SUB ? SUBTRACTIVE_TRANSPARENCY : TRANSLUCENT_TRANSPARENCY)).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build(false));
            }
        }
        OBJ_OUTLINE_RENDER_TYPE = RenderLayer.of((String)"lm_obj_outline_no_cull", (VertexFormat)POS_TEX_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.TRIANGLES, (int)256, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)RenderLayer.MultiPhaseParameters.builder().depthTest(ALWAYS_DEPTH_TEST).cull(DISABLE_CULLING).target(OUTLINE_TARGET).build(false));
        ...
        ENTITY_CUTOUT = Util.memoize(p_173202_ -> {
            ...
            return RenderLayer.of((String)"nop_entity_cutout", (VertexFormat)POS_TEX_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.TRIANGLES, (int)256, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)rendertype$compositestate);
        });
    }
