...
extends Item {
    ...
    public void appendTooltip(ItemStack stack, World level, List<Text> list, TooltipContext flag) {
        ...
        if (compound == null || !compound.contains("Entity", 10)) {
            list.add((Text)Text.literal((String)(String.valueOf(Formatting.RED) + "Error")));
            return;
        }
        ...
        list.add((Text)Text.literal((String)String.valueOf(Formatting.BLUE)).append((Text)name));
