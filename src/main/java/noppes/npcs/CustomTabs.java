...
public class CustomTabs {
    public static void registerCreativeTab() {
        Registry.register((Registry)Registries.ITEM_GROUP, (Identifier)new Identifier("customnpcs", "cnpcs"), FabricItemGroup.builder().displayName((Text)Text.literal((String)"cnpcs")).icon(() -> CustomItems.wand.getDefaultStack()).entries((params, output) -> {
