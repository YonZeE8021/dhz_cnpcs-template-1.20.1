...
extends JobInterface {
    ...
    public void aiUpdateTask() {
        ...
        if (this.nextLine != null) {
            ...
            List<PlayerEntity> inRange = this.npc.getWorld().getNonSpectatingEntities(PlayerEntity.class, this.npc.getBoundingBox().expand((double)this.range, (double)this.range, (double)this.range));
    ...
    private boolean shouldRun() {
        ...
        this.npcs.clear();
        List<EntityNPCInterface> list = this.npc.getWorld().getNonSpectatingEntities(EntityNPCInterface.class, this.npc.getBoundingBox().expand(10.0, 10.0, 10.0));
