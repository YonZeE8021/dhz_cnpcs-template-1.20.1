...
IQuest {
    ...
    public NbtCompound mailData = new NbtCompound();
    public PlayerMail mail = new PlayerMail();
    @DatabaseColumn(name="quest_data", type=DatabaseColumn.Type.JSON)
    public NbtCompound questData = new NbtCompound();
    ...
    public NbtCompound rewardItemsData = new NbtCompound();
    ...
    public void readNBTPartial(NbtCompound compound) {
    ...
    public NbtCompound writeToNBTPartial(NbtCompound compound) {
        ...
        compound.put("Rewards", (NbtElement)this.rewardItems.getToNBT());
        ...
        compound.put("QuestFactionPoints", (NbtElement)this.factionOptions.save(new NbtCompound()));
        compound.put("QuestMail", (NbtElement)this.mail.writeNBT());
        return compound;
    }
    ...
    public Quest copy() {
        ...
        quest.readNBT(this.save(new NbtCompound()));
        return quest;
    }
    ...
    public IQuestObjective[] getObjectives(IPlayer player) {
        ...
        return this.questInterface.getObjectives((PlayerEntity)player.getMCEntity());
    }
    ...
    public IContainer getRewards() {
        return NpcAPI.Instance().getIContainer((Inventory)this.rewardItems);
    }
}
