...
public class RecipesDefault {
    ...
    public static void loadDefaultRecipes(int i) {
        if (i < 0) {
            RecipesDefault.addRecipe("npc_wand", CustomItems.wand, true, "XX", " Y", " Y", Character.valueOf('X'), Items.BREAD, Character.valueOf('Y'), Items.STICK);
            RecipesDefault.addRecipe("mob_cloner", CustomItems.cloner, true, "XX", "XY", " Y", Character.valueOf('X'), Items.BREAD, Character.valueOf('Y'), Items.STICK);
        }
    }
}
