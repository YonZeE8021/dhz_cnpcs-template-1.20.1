...
public class CmdNPC {
    ...
    public static LiteralArgumentBuilder<ServerCommandSource> register() {
        LiteralArgumentBuilder command = (LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal((String)"npc").requires(source -> source.hasPermissionLevel(CustomNpcs.NoppesCommandOpOnly ? 4 : 2))).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument((String)"npc", (ArgumentType)StringArgumentType.string()).then(CommandManager.literal((String)"home").then(CommandManager.argument((String)"pos", (ArgumentType)BlockPosArgumentType.blockPos()).executes(context -> {
