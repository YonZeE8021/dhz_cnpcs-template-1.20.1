...
extends PacketBasic {
    ...
    public PacketNpcRole(int id, NbtCompound data) {
        this.id = id;
        this.data = data;
    }

    public static void encode(PacketNpcRole msg, PacketByteBuf buf) {
        buf.writeInt(msg.id);
        buf.writeNbt(msg.data);
    }

    public static PacketNpcRole decode(PacketByteBuf buf) {
